    ...
    >
        ...
        <div className="inline-block relative">
          ...
          <h2
            className="
              ...
              md:mb-6
              relative
              drop-shadow-[0_0_15px_rgba(248,228,26,0.5)]
              md:drop-shadow-[0_0_20px_rgba(248,228,26,0.5)]
              text-3xl
              md:text-4xl
              lg:text-5xl
            "
          ...
          <div className="flex items-center justify-center gap-1.5 md:gap-2">
            ...
            <div
              className="
                ...
                rounded-full
                bg-[#f8e41a]
                shadow-[0_0_8px_rgba(248,228,26,0.6)]
              "
            />
      ...
      >
        {team.members?.map((member, index) => (
          <Member key={member?._key || index} member={member} index={index} />
        ))}
      </div>
    </section>
  );
  ...
  return (
    <div
      ...
      className={twJoin(
        ...
        "shadow-[0_18px_50px_rgba(0,0,0,0.45),0_0_0_1px_rgba(248,228,26,0.12)]",

        "hover:shadow-[0_30px_75px_rgba(0,0,0,0.65),0_0_35px_rgba(248,228,26,0.3)]",
      ...
      <div className="absolute inset-0 opacity-70 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
        <div
          className="
            ...
            w-full
            h-10
            bg-[radial-gradient(circle_at_50%_50%,rgba(106,139,85,0.22),transparent_60%)]
            blur-2xl
          "
        />
        ...
        <div
          className="
            ...
            w-full
            h-10
            bg-[radial-gradient(circle_at_50%_50%,rgba(74,80,54,0.2),transparent_60%)]
            blur-2xl
          "
        />
      </div>
  ...
  return (
    ...
    >
      ...
      {member.socials?.map((social) => {
        ...
        const { _key, socialMedia, url } = social;

        // No platform or URL → don't render
        if (!socialMedia || !url) {
          return null;
        }
